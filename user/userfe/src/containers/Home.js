...
class Home extends React.Component {
                ...
                <div className="container-visitor ">
                    <div className="row">
                        <div className="col-md-8 col-xs-12 col-sm-12 col-lg-7">
                            ...
                            <a className="btn btn-primary m-md-bottom m-0-bottom-md m-0-bottom-xl m-0-right-xs btn-block-sm"
                    ...
                    <div className="row">
                        ...
                        <div className="item col-md-4 col-xl-3">
                            <div
                                ...
                                <p className="m-0"> Người học có thể tìm kiếm người dạy phù hợp dựa theo tùy chọn
                    </p>
                            </div>
                        </div>
                        <div
                            ...
                            <div className="use-case p-lg-left p-xs-top-bottom p-0-top-bottom-xs">
                                ...
                                <p className="m-0"> U4T hỗ trợ quản lý thống kê lịch sử hợp đồng
                    </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="d-flex">
                        <div className="text-center">
                            ...
                            <p className="m-md-top text-center m-0-bottom">
                                <strong className="font-14"> ${giaTien}</strong>
                                <small>/giờ</small>
                            </p>
                        </div>
                        <div className="p-sm-left tile-text-part">
                            ...
                            <p className="m-sm-bottom tile-title vs-full-word-cut-text">{tieuDe}</p>
                            ...
                            <small className="d-block m-xs-top vs-color-gray ellipsis p-xs-top p-0-top-xs">{thanhPho},Viet Nam</small>
                        </div>
                    </div>
    ...
    renderTopTeacher() {
        var test = [{ avatar: '', giaTien: 20, fullName: 'Nguyen Hungw', tieuDe: 'La mot giao vien tieu bieu nhat he mat troi', thanhPho: 'Ho Chi Minh', skills: ['Toan', 'Ly', 'Hoa'] },
        ...
        return (
            <section className="fl-carousel-section  ng-scope">
                ...
                <div className="d-none d-xl-block p-md-bottom"></div>
                            ...
                            <div className="col-xs-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 col-xl-6 col-xl-offset-3 ng-scope">
                                <div className="text-center m-lg-top">
                                    <div className="text-center m-lg-top">
                                        <div>
                                            <a href='/search'
                                                className="btn-block-sm btn-primary btn-submit btn m-0 btn m-0">Tìm kiếm ngay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
