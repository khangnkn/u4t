                ...
                <div className="row">
                    <div className="col-sm-6 m-lg-bottom">
                        <div className="form-group">
                            ...
                            <Form.Control type="text" onChange={this.handleInforChange} value={user.infor.hoTen} name="hoTen" className="form-control sessioncamexclude" />
                    ...
                    <div className="col-sm-6 m-lg-bottom">
                        <div className="form-group">
                            ...
                            <Form.Control as="select" onChange={this.handleInforChange} selected={user.infor.gioiTinh} name="gioiTinh" className="form-control sessioncamexclude">
                ...
                <div className="row">
                    <div className="col-sm-6 m-lg-bottom">
                        <div className="form-group">
                            ...
                            {/* {this.validator.message('email',this.props.profile.user.infor.email,'required|email','text-danger')} */}
                    ...
                    <div className="col-sm-6 m-lg-bottom">
                        <div className="form-group">
                            ...
                            <Form.Control type="text" onChange={this.handleInforChange} value={user.infor.sdt} name="sdt" className="form-control sessioncamexclude" />
                ...
                <div className="row">
                    <div className="col-sm-6 m-lg-bottom">
                        <div className="form-group">
                            ...
                            <Form.Control type="text" onChange={this.handleInforChange} value={user.infor.diaChi} name="diaChi" className="form-control sessioncamexclude" />
                        </div>
                    </div>
                    <div className="col-sm-6 m-lg-bottom">
                        <div className="form-group">
                            <Form.Label className="">Tỉnh/Thành phố</Form.Label>
                            <Form.Control as="select" className="form-control sessioncamexclude" value={user.infor.ttp} onChange={this.handleInforChange} name="ttp">
                    ...
                    <div className="row">
                        {/* {this.states.skills.map((e, i) => {
                            ...
                            return (
                                ...
                                <Form.Label>
                                    <Form.Control type="checkbox" selected={flat} onChange={this.handleSkillsChange} name="kyNang" value={e._id} />
        ...
        return (
            <div className="modal-body">
                ...
                <div className="form-group">
                    ...
                    <Form.Control type="text" placeholder="Ví dụ: Admin Support,Java Developer" value={user.data.tieuDe} className="form-control" onChange={this.handleDataChange} name="tieuDe" />
                </div>
                <div className="form-group overview-box">
                    ...
                    <div className="up-disintermediation-container">
                        <div>
                            <Form.Control as="textarea" rows="7" value={user.data.tongQuan} placeholder="Hãy mô tả tổng quan về bản thân,trình độ,kỹ thuật để người học hiểu rõ hơn về bạn." className="form-control" onChange={this.handleDataChange} name="tongQuan"></Form.Control>
