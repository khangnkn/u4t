                                    ...
                                    <div className="ng-scope">
                                        <div className="ng-isolate-scope">
                                            <div
                                              ...
                                              >
                                                <div
                                                    className="progress-bar progress-bar-complimentary"
                                                    style={{ width: '96%' }}
                                                  >
                                                    <span className="ng-binding">
                                                        {tutor.data.ratingAve}
                                                        <span
                        ...
                        <div>
                            <div className="ng-scope ng-isolate-scope">
                                <div className="o-profile-skills m-sm-top ng-scope">
                                    {skills.map((e, i) => (<a key={i} className="o-tag-skill ng-binding ng-scope" href="#" disable>{e.moTa}</a>))}
                                  </div>
                              </div>
                          </div>
                      </section>
