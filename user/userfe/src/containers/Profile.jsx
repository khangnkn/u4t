            ...
            <div className="modal-body">
                ...
                <div className="form-group">
                    ...
                    <div className="dropdown width-lg fe-cat-height dropdown-block">
                        <Form.Control as="select" className="custom-select" value={data.level} onChange={handleDataChange} name="level" style={{height: '40px'}}>
                        ...
                        {state.skills.map((e, i) => {
                            ...
                            return (
                                <div className="checkbox col-md-6" key={i}>
                                    <Form.Label>
                                        <Form.Control type="checkbox" selected={flat} onChange={handleSkillsChange} name="skills" value={e._id} />
                                            ...
                                            <div className="step-manager-modal">
                                                <div className="modal-content">
                                                    ...
                                                    <div className="modal-flex-container flex-1">
                                                        ...
                                                        {step === 1 ? renderInforForm(state) : step === 2 ? renderJobForm(state) : renderOverviewForm(state)}
                                                        {renderFooterForm()}
                                                    </div>
                                                </div>
                                            </div>
