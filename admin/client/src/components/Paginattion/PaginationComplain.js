...
class PaginationComplain extends React.Component {
  constructor() {
    super();
  }
...
function mapStateToProps(state) {
  const { complain } = state;
  return {
    page: complain.page,
    totalPages: complain.totalPages,
    limit: complain.limit,
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(PaginationComplain);
